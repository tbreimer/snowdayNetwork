# Takes 2017.csv as input, and creates 2017data.csv, which includes weather data for all days in 2017
# An api key for Dark Sky is required
...
for z in range(0, length):
    ...
    writeEvent(lat, lon, int("20" + str(year)), month, day, outcome)
