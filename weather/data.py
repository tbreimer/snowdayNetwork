# Takes the 0th to 450th entries in combinedData.csv and adds the weather data and saves it combinedWeatherData.csv
...
file = open('combinedWeatherData1.csv', 'w');
